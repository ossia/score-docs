...
<!-- You can now start sequencing your devices' states in your scenario or read [detailed informations about states management]({{ site.baseurl }}/docs/reference-manual/store-and-recall-devices-states.html). -->
