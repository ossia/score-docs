...
![Dropping parameters]({{ site.baseurl }}/assets/images/reference-manual/processes/dropping-parameters.png "Dropping parameters")
...
![Dropping processes]({{ site.baseurl }}/assets/images/reference-manual/processes/dragging-processes.gif "Dropping processes")
...
![Parallel or serial processes]({{ site.baseurl }}/assets/images/reference-manual/processes/parallel-or-serial-processes.gif "Parallel or serial processes")
...
![Process addition widget]({{ site.baseurl }}/assets/images/reference-manual/processes/add-process-from-interval.png "Process addition widget")
...
![Add process window]({{ site.baseurl }}/assets/images/reference-manual/processes/add-process-from-interval-window.png "Add process window")
...
![Remove from Graph inspector]({{ site.baseurl }}/assets/images/reference-manual/processes/remove-process-from-graph.png "Remove from Graph inspector")
...
![Edit process in full size]({{ site.baseurl }}/assets/images/reference-manual/processes/process-fullsize-edit.gif "Edit process in full size")
...
![Process looping]({{ site.baseurl }}/assets/images/reference-manual/common-practices/loopProcess.gif "Process looping")
...
![Fold/unfold processes]({{ site.baseurl }}/assets/images/reference-manual/processes/fold-unfold-processes.gif "Fold/unfold processes")
...
![Fold/unfold processes]({{ site.baseurl }}/assets/images/reference-manual/processes/fold-process-menu.png "Fold/unfold processes")
...
![Bring process to front]({{ site.baseurl }}/assets/images/reference-manual/processes/bring-to-front.png "Bring process to front")
...
![Moving processes]({{ site.baseurl }}/assets/images/reference-manual/processes/moving-processes.gif "Moving processes")
