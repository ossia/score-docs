...
![Device setup window]({{ site.baseurl }}/assets/images/reference-manual/devices-types/device_setup_window.png "score device setup")
...
![OSC device top node]({{ site.baseurl }}/assets/images/reference-manual/devices-types/osc_top_node.png "OSC device top node")
...
![Addresses learning]({{ site.baseurl }}/assets/images/reference-manual/devices-types/osc_learning.png "OSC learn")
...
![Monitoring value changes]({{ site.baseurl }}/assets/images/reference-manual/devices-types/testing_osc.png "Monitoring distant parameter's value")
...
![OSC node]({{ site.baseurl }}/assets/images/reference-manual/devices-types/osc_node.png "Create an OSC node")
...
![Parameter type]({{ site.baseurl }}/assets/images/reference-manual/devices-types/parameter_type.png "Create an OSC parameter")
...
![Parameter attributes]({{ site.baseurl }}/assets/images/reference-manual/devices-types/parameter_attributes.png "Parameter's attributes")
