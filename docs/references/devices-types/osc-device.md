...
![Device setup window](/assets/images/references/devices-types/device_setup_window.png "score device setup")
...
![OSC device top node](/assets/images/references/devices-types/osc_top_node.png "OSC device top node")
...
![Addresses learning](/assets/images/references/devices-types/osc_learning.png "OSC learn")
...
![Monitoring value changes](/assets/images/references/devices-types/testing_osc.png "Monitoring distant parameter's value"_)
...
![OSC node](/assets/images/references/devices-types/osc_node.png "Create an OSC node")
...
![Parameter type](/assets/images/references/devices-types/parameter_type.png "Create an OSC parameter")
...
![Parameter attributes](/assets/images/references/devices-types/parameter_attributes.png "Parameter's attributes")
